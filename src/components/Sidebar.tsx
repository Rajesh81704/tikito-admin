  ...
  return (
    <>
      ...
      <aside className={`
        ...
        w-[260px] min-h-screen flex flex-col flex-shrink-0 border-r border-[rgba(77,175,112,0.18)]
      ...
      `} style={{
        ...
        {/* Logo */}
        <div className="relative px-6 pt-7 pb-5 border-b border-[rgba(77,175,112,0.15)] flex items-start justify-between">
          <div>
          ...
          {/* Mobile close button */}
          <button onClick={onClose} className="lg:hidden p-1.5 rounded hover:bg-[rgba(77,175,112,0.12)] transition cursor-pointer relative">
